...
// +kubebuilder:rbac:groups=etcd.fyl253711.gitee.com,resources=etcdbackups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=etcd.fyl253711.gitee.com,resources=etcdbackups/status,verbs=get;update;patch
